    ...
    <g id="309041_users_group_people_icon (1) 1">
      ...
      <g id="Group_2">
        <g id="Group_3">
          <path
            id="Vector_2"
            d="M18.5 11C19.8807 11 21 9.88071 21 8.5C21 7.11929 19.8807 6 18.5 6C17.1193 6 16 7.11929 16 8.5C16 9.88071 17.1193 11 18.5 11Z"
            fill="#9597AB"
          />
        </g>
        <g id="Group_4">
          <path
            id="Vector_3"
            d="M18.5 13C17.3 13 16.4 13.3 15.7 13.8C18 14.9 18.9 16.8 18.9 17V17.1H23V15.8C23 15.7 21.9 13 18.5 13Z"
            fill="#9597AB"
          />
        </g>
      </g>
